...
class Program
{
...

    {
        ...
        Console.WriteLine("1. cambio prima carta ");
        Console.WriteLine("2. cambio seconda carta");
        Console.WriteLine("3. cambio terza carta");
        ...
        Console.WriteLine(carta.GetSeme() + " " + carta.GetValore()); 
        Console.ReadLine();
        Console.WriteLine(carta1.GetSeme() + " " + carta1.GetValore()); 
        Console.ReadLine();
        Console.WriteLine(carta2.GetSeme() + " " + carta2.GetValore()); 
        Console.ReadLine();

int somma = carta.GetValore() + carta1.GetValore() + carta2.GetValore();
