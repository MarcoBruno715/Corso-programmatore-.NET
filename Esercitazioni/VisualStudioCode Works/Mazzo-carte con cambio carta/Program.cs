...
class Program
{
	static void Main(string[] args)
	{
        ...
        Carta carta1 = mazzo.Pesca(); // pesco una carta
        Carta carta2 = mazzo.Pesca(); 
        Carta carta3 = mazzo.Pesca();
        Carta carta4= mazzo.Pesca(); 
        ...
        Console.WriteLine(carta2.GetSeme() + " " + carta2.GetValore()); // stampo il seme e il valore della carta
	    Console.WriteLine(carta3.GetSeme() + " " + carta3.GetValore()); // stampo il seme e il valore della carta
	    Console.WriteLine(carta4.GetSeme() + " " + carta4.GetValore()); // stampo il seme e il valore della carta
		    
        Console.WriteLine("Cambia 3 carte");
